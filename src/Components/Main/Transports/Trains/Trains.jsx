...
function Trains({filter}) {
  ...
  const selectedCards = getCardsByIdRange(89, 101);
  ...
  return (
    <div className="mostPopularRailwaysContainer">
      <h1>Most Popular Trains</h1>
      <Slider {...sliderSettings}>
        {selectedCards.map((card, index) => {
          const isCenter = index === currentSlide;
          return (
            <div
              className={`mostPopularRailwaysCardsContainer ${
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span className="mostPopularRailwaysCardContextContainer">
